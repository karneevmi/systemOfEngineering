...
**UC-01 Управление пользователями**
- регистрация и авторизация;
- подписки на темы;
- избранные новости.

**UC-02 Сбор новостей**
- RSS / REST API / парсинг сайтов;
- поддержка 50+ источников;
- автоматическое и ручное добавление;
- фильтрация дубликатов (≥90%).

**UC-03 Обработка контента**
- NLP-категоризация;
- анализ тональности;
- определение релевантности.

**UC-04 Доставка контента**
- персонализированная лента;
- полнотекстовый поиск;
- фильтры (дата, источник, теги).
